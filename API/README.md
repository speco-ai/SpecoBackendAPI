...
```bash
$ mvn archetype:generate -DartifactId=API -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-jersey-archetype -DarchetypeVersion=1.6.1 -DgroupId=api.com -Dversion=0.0.1-SNAPSHOT -Dinteractive=false
$ cd API
$ sam build
